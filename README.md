This is hard fork of go-micro which is initially developed by Asim Aslam.
...
# Go Micro [![License](https://img.shields.io/:license-apache-blue.svg)](https://opensource.org/licenses/Apache-2.0) [![Go.Dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/itzmanish/go-micro/v2?tab=doc) [![Travis CI](https://api.travis-ci.org/itzmanish/go-micro.svg?branch=master)](https://travis-ci.org/itzmanish/go-micro) [![Go Report Card](https://goreportcard.com/badge/itzmanish/go-micro)](https://goreportcard.com/report/github.com/itzmanish/go-micro)
